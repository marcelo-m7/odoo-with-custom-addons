...
export const projectRemarkStateSelection = { ...projectTaskStateSelection, fieldDependencies: [{ name: "project_id", type: "many2one" }], component: ProjectRemarkStateSelection };
